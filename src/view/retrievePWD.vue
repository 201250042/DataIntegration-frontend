  ...
  <div class="resetPassword">
    <div class="container">
      ...
      <div class="common_div">
        <el-button  @click="next"  class="action_button">下一步</el-button>   <!--"next"后面本来有 :disabled="disabled"-->
      ...
      if (this.active === 2) {
        ...
        if (this.passwordForm.password === '') {
          ...
          /* if (successResponse.data.code === 200) */
          {
            ...
            this.$router.replace({path: path === '/' || path === undefined ? '/identify' : path})/*最终返回的页面*/
          }/*else if (successResponse.data.code === 400) {
              //修改密码失败，返回对应信息
              this.$message.error(successResponse.data.message);*/
...
<style scoped>
.resetPassword{
  background-image: url("@/view/img/bricks.jpg");
